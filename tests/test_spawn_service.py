"""Tests for spawn task service registration (HA-free)."""
...
@pytest.mark.asyncio
async def test_spawn_task_service_registered() -> None:
    ...
    assert integration.SERVICE_SPAWN_TASK in service_names
